...
class WebAppApplicationTests {
        ...
        public void shouldReturnLuis() throws Exception {
                this.mockMvc.perform(get("/luis"))
                                .andDo(print()).andExpect(status().isOk())
                                .andExpect(content()
                                                .string(containsString("Hello, Luis!")));
        }
        ...
        public void shouldReturnBranchLuis() throws Exception {
                this.mockMvc.perform(get("/branch/luis"))
                                .andDo(print()).andExpect(status().isOk())
                                .andExpect(content()
                                                .string(containsString("Hello, Branch Luis!")));
        }

        @Test
        public void shouldReturnForkLuis() throws Exception {
                this.mockMvc.perform(get("/fork/luis"))
                                .andDo(print()).andExpect(status().isOk())
                                .andExpect(content()
                                                .string(containsString("Hello, Fork Luis!")));
        }
        
        @Test
        public void shouldReturnBranchMateus() throws Exception {
                this.mockMvc.perform(get("/branch/Mateus-Henrique"))
                                .andDo(print()).andExpect(status().isOk())
                                .andExpect(content()
                                                .string(containsString("Hello, Branch Mateus!")));
        }
        
        @Test
        public void shouldReturnForkMateus() throws Exception {
                this.mockMvc.perform(get("/fork/Mateus"))
                                .andDo(print()).andExpect(status().isOk())
                                .andExpect(content()
