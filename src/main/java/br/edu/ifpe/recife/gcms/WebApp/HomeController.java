...
public class HomeController {
    ...
    @RequestMapping("/branch/luis")
    public @ResponseBody String greetingBranchLuis() {
        return "Hello, Branch Luis!";
    }
    
    @RequestMapping("/fork/luis")
    ...
    @RequestMapping("/fork/Mateus")
    public @ResponseBody String greetingForkMateus() {
   ...
   @RequestMapping("/branch/Marta-Santos")
    public @ResponseBody String greetingFromBranchMarta() {
        return "Hello from branch Marta-Santos!";
    }
